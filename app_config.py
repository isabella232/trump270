...
PROJECT_SLUG = 'trump270-4lkj98513nN3'

# Project name to be used in file paths
PROJECT_FILENAME = 'trump270'

# The name of the repository containing the source
REPOSITORY_NAME = 'trump270'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1O21BonRi9GV2kbCntYwj4-qnoLIRgI-8wTyIMFT4b34'
COPY_PATH = 'data/copy.xlsx'
DATA_GOOGLE_DOC_KEY = '12_F0yhsXEPN1w3GOlQB4_NKGadXiRLOa9l-HQu5jSL8'
DATA_PATH = 'data/data.xlsx'
PROCESSED_DATA_PATH = 'www/js/data.json'
